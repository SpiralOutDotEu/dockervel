...
alias dcomposer-create-lumen='docker-compose run composer create-project laravel/lumen /var/www --prefer-dist'
...
alias dunit='docker-compose run  --entrypoint "php /var/www/vendor/bin/phpunit" artisan'
